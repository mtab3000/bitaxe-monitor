#!/usr/bin/env python3
"""
Multi-Bitaxe Gamma Miner KPI Monitor - Refactored Version with Variance Tracking
Polls multiple miners every 30 seconds for comprehensive performance metrics
Tracks hashrate variance over 60s, 300s, and 600s windows
"""
...
class MultiBitaxeMonitor:
    ...
    def run_monitor(self, show_detailed=False):
        ...
        print("🚀 Starting Multi-Bitaxe Monitor with Variance Tracking")
